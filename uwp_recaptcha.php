...
define( 'UWP_RECAPTCHA_VERSION', '1.0.3' );
...
class UsersWP_Recaptcha {
    ...
    public function add_scripts() {
        wp_enqueue_script( 'uwp_recaptcha_script', $this->plugin_url . 'assets/js/script.js', array( 'jquery', 'uwp_recaptcha_js_api' ), $this->version, true );
